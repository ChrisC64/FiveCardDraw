...
void Hand::SetHand(std::vector<Card> *c)
{
    AddToHand(c);
}
...
// OVERRIDE 
void Hand::SortHandHighLow(std::vector<Card> *c)
{
    if (c->empty())
    {
...
// OVERRIDE
void Hand::SwapCards(std::vector<Card> *c, int pos1, int pos2)
{
    // Create temp
    std::vector<Card> temp;
...
void Hand::AddToHand(std::vector<Card> *c)
{
