...
private:
    ...
    Deck* m_Deck;
    std::vector<Card> *m_DealtCards;
    std::vector<Card> m_Cards;
    std::vector<Card> m_vUniqueCards; 
    std::list<Player*> m_highCardList;
...
public:
    ...
    */
    void SetCategory(Player *p, Hand::CATEGORY eCategory);
